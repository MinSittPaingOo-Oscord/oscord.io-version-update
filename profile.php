...
<div class="bg-white text-black min-h-screen">
    <div class="max-w-7xl mx-auto px-6 py-16">
        ...
        <?php if (isset($_SESSION['error'])): ?>
            <div class="max-w-lg mx-auto mb-8 bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-none text-center">
        ...
        <?php if (isset($_SESSION['success'])): ?>
            <div class="max-w-lg mx-auto mb-8 bg-green-50 border border-green-200 text-green-700 px-6 py-4 rounded-none text-center">
        ...
        <?php if (function_exists('isLoggedIn') && isLoggedIn()): ?>
            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="lg:w-56 flex-shrink-0 border-r-2 border-black py-8 pr-8">
                    <div class="font-light text-2xl mb-10 tracking-[-1px]">My Account</div>
        ...
        <?php else: ?>
            <!-- NOT LOGGED IN - ORIGINAL CARDS RESTORED -->
            <div class="max-w-5xl mx-auto">
                <div class="text-center mb-20">
                    <h1 class="text-[4.5rem] md:text-[5.5rem] font-light tracking-[-3px] leading-none">Oscord Code Academy</h1>
                    <p class="text-2xl text-zinc-500 mt-6 font-light">Master programming with elegance.</p>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="bg-white border-2 border-black p-12 md:p-16 flex flex-col items-center text-center hover:border-purple-600 transition-all">
                        <div class="mb-12">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-28 h-28 text-black mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.25">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                        </div>
                        <h2 class="text-5xl font-light mb-3">SIGN IN</h2>
                        <p class="text-xl text-zinc-600 mb-16">Welcome back to your account.</p>
                        <a onclick="openLoginModal(); return false;" class="block w-full bg-black text-white hover:bg-purple-700 font-medium text-2xl py-7 rounded-none transition-all text-center cursor-pointer">
                            LOGIN
                        </a>
                    </div>
                    
                    <div class="bg-white border-2 border-black p-12 md:p-16 flex flex-col items-center text-center">
                        <div class="mb-12">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-28 h-28 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.25">
                        ...
                        <h2 class="text-5xl font-light mb-3">JOIN US</h2>
                        <p class="text-xl text-zinc-600 mb-16">Create a new account today.</p>
                        <a href="register.php" class="block w-full bg-black text-white hover:bg-purple-700 font-medium text-2xl py-7 rounded-none transition-all">
                            REGISTER
                        </a>
                    </div>
                </div>
